  ...
  return (
    <div className="w-screen h-screen fixed top-0 left-0 bg-black/80 flex items-center justify-center">
      <div className="w-full h-3/5 mx-4 bg-slate-300/60 rounded-lg p-8 shadow-lg shadow-black text-center flex flex-row flex-wrap justify-center md:w-4/5 lg:w-3/5 lg:h-96 xl:h-4/5 xl:w-1/3">
        ...
        <button
          className="w-28 h-8 bg-red-500 mr-4 font-bold text-white hover:bg-red-700 hover:transform hover:scale-110 rounded-lg shadow-lg shadow-black hover:text-black 2xl:w-44 2xl:h-14 2xl:text-xl"
          onClick={() => deleteUser(userToDelete)}
        >
          Eliminar
        </button>
        <button
          className="w-28 h-8 bg-blue-500 ml-4 font-bold text-white hover:bg-blue-700 hover:transform hover:scale-110 rounded-lg shadow-lg shadow-black hover:text-black 2xl:w-44 2xl:h-14 2xl:text-xl"
